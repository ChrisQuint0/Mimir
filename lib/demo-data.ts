...
export const DEMO_BOOTCAMP = {
  ...
  current_day: 1,
  caption:
    "A comprehensive React bootcamp designed for developers who want to master modern React development patterns and best practices.",
...
export const DEMO_SYLLABUS = {
  days: [
    // Module 1: Foundations (Days 1-2)
    {
      ...
      description:
        "Introduction to React, JSX, and component basics. Set up your development environment and create your first components.",
      topics: [
        "What is React?",
        "JSX syntax",
    ...
    },
    {
      ...
      description:
        "Hands-on practice with React components, props, and JSX. Build simple UI components and understand component composition.",
      topics: [
    ...
    // Module 2: State & Events (Days 3-4)
    {
      ...
      description:
        "Learn about component state, event handling, and how to make your components interactive.",
      topics: [
        "useState hook",
        "Event handlers",
    ...
    },
    {
      ...
      description:
        "Build interactive forms and dynamic UI components using state and event handlers.",
      topics: [
        "Interactive forms",
        "State updates",
        "Event patterns",
    ...
    // Module 3: Component Lifecycle (Days 5-7)
    {
      ...
      description:
        "Understand component lifecycle with useEffect. Learn side effects, data fetching, and cleanup.",
      topics: [
        "useEffect hook",
        "Dependency arrays",
        "Cleanup functions",
    ...
    },
    {
      ...
      description:
        "Practice data fetching, subscriptions, and effect cleanup in real-world scenarios.",
      topics: [
        "API integration",
        "Async operations",
        "Cleanup patterns",
    ...
    },
    {
      ...
      description:
        "Consolidate your knowledge by building a data-fetching application with proper lifecycle management.",
      topics: [
        "Project: Weather app",
        "Review lifecycle concepts",
        "Debug common issues",
        "Performance tips",
      ],
    },
    // Module 4: Lists & Keys (Days 8-9)
    {
      ...
      description:
        "Master rendering lists, using keys effectively, and conditional rendering patterns.",
      topics: [
        "Rendering lists",
    ...
    },
    {
      ...
      description:
        "Build dynamic lists and implement various conditional rendering patterns.",
      topics: [
    ...
    // Module 5: Advanced Hooks (Days 10-12)
    {
      ...
      description:
        "Explore useReducer, useCallback, useMemo, and useRef for complex state and performance optimization.",
    ...
    },
    {
      ...
      description:
        "Apply advanced hooks to optimize performance and manage complex state logic.",
      topics: [
    ...
    },
    {
      ...
      description:
        "Deep dive into when and why to use each advanced hook with real-world examples.",
      topics: [
        "Hook patterns",
    ...
    // Module 6: Context API (Days 13-15)
    {
      ...
      description:
        "Learn the Context API for state management across components without prop drilling.",
      topics: [
        "Context API basics",
        "Provider pattern",
        "useContext hook",
    ...
    },
    {
      ...
      description:
        "Implement theme switching and user authentication state with Context API.",
      topics: [
        "Theme context",
        "Auth context",
        "Multiple contexts",
    ...
    },
    {
      ...
      description:
        "Build a multi-theme application with global state management using Context API.",
      topics: [
    ...
    // Module 7: React Router (Days 16-17)
    {
      ...
      description:
        "Master client-side routing with React Router for building multi-page applications.",
      topics: [
        "React Router setup",
    ...
    },
    {
      ...
      description:
        "Build a multi-page application with navigation, dynamic routes, and protected routes.",
      topics: [
        "Navigation components",
        "Protected routes",
        "Route guards",
        "Practice: Blog routing",
      ],
    },
    // Module 8: Forms & Validation (Days 18-19)
    {
      ...
      description:
        "Learn form handling, validation strategies, and form libraries like React Hook Form.",
      topics: [
    ...
    },
    {
      ...
      description:
        "Build complex forms with validation, error messages, and proper user feedback.",
      topics: [
        "Multi-step forms",
        "Custom validators",
        "Async validation",
    ...
    // Module 9: API Integration (Days 20-21)
    {
      ...
      description:
        "Master API integration with fetch, axios, and modern data fetching libraries.",
      topics: [
        "REST APIs",
        "Fetch vs Axios",
        "Error handling",
    ...
    },
    {
      ...
      description:
        "Build a data-driven application with full CRUD operations and proper error handling.",
      topics: [
        "CRUD operations",
        "Optimistic updates",
        "Error boundaries",
        "Practice: API dashboard",
      ],
    },
    // Module 10: State Management (Days 22-24)
    {
      ...
      description:
        "Explore state management solutions: Redux, Zustand, and when to use them.",
      topics: [
        "Redux basics",
        "Zustand",
    ...
    },
    {
      ...
      description:
        "Implement global state management with Zustand in a real application.",
      topics: [
        "Store setup",
    ...
    },
    {
      ...
      description:
        "Build a shopping cart with global state management and persist data.",
      topics: [
    ...
    // Module 11: Performance (Days 25-26)
    {
      ...
      description:
        "Learn React performance optimization techniques: memoization, code splitting, lazy loading.",
      topics: [
        "React.memo",
        "Code splitting",
        "Lazy loading",
    ...
    },
    {
      ...
      description:
        "Apply performance optimization techniques to improve application performance.",
      topics: [
    ...
    // Module 13: Advanced Patterns (Day 29)
    {
      ...
      description:
        "Master advanced patterns: render props, higher-order components, compound components.",
      topics: [
        "Render props",
        "HOCs",
        "Compound components",
    ...
    // Module 14: Production & Deployment (Day 30)
    {
      ...
      description:
        "Final review and deploy your React application to production. Best practices and next steps.",
      topics: [
        "Production build",
...
export const DEMO_ACTIVITIES = [
  {
    id: "demo-activity-1",
    question:
      "Create a \`Button\` component that accepts a \`label\` prop and an \`onClick\` prop. The button should display the label text and call the onClick function when clicked.",
    answer: `\`\`\`jsx
...
**Explanation**: This component accepts two props: \`label\` for the button text and \`onClick\` for the click handler. When the button is clicked, it calls the function passed via props. This pattern makes the button reusable across your application.`,
  ...
  },
  {
    id: "demo-activity-2",
    question:
      "Build a \`ProfileCard\` component that displays a user's name, email, and profile picture. Accept these as props and render them in a styled card layout.",
    answer: `\`\`\`jsx
...
**Why this works**: The component destructures props to access name, email, and profilePicture. Using semantic HTML and className attributes, we can style this card with CSS. This pattern is perfect for displaying user information throughout your app.`,
  ...
  },
  {
    id: "demo-activity-3",
    question:
      "Create a \`ProductList\` component that receives an array of products as a prop. Each product has \`id\`, \`name\`, and \`price\`. Render the list using \`.map()\` and proper keys.",
    answer: `\`\`\`jsx
...
3. Keys help React identify which items changed for efficient updates`,
  ...
  },
  {
    id: "demo-activity-4",
    question:
      "Explain the difference between props and state in React. When would you use each, and why are props read-only?",
